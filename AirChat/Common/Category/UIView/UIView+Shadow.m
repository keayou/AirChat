...
- (void)makeInsetShadow
{
    ...
    UIColor *color = [UIColor colorWithRed:(0/255.0) green:(0/255.0) blue:(0/255.0) alpha:0.10];
    
    UIView *shadowView = [self createShadowViewWithRadius:6 Color:color Directions:shadowDirections];
